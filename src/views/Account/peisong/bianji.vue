<template>
  <div>
    <div class="nav_top">
      <p class="pj1">
        <span>
          <a style="margin-left: 9px;">编辑模板</a>
        </span>
      </p>
    </div>
    <div class="box">
      <div class="body">
        <table class="bg" style="border-collapse:collapse;">
          ...
          <tr>
            ...
            <td class="secend">
              <el-select v-model="value" placeholder="广东省" size="small">
                <el-option
              ...
              <el-select v-model="value1" placeholder="广州市" size="small">
                <el-option
              ...
              <el-select v-model="value2" placeholder="越秀区" size="small">
                <el-option
                  v-for="item in options2"
                  :key="item.value"
                  :label="item.label"
          ...
          <tr>
            ...
            <td class="secend">
              <el-row class="ts">
               ...
               <el-row class="ts1">
                <el-col :span="4">广东省 </el-col>
                <el-col :span="4">1</el-col>
                <el-col :span="4">8</el-col>
                <el-col :span="4">1</el-col>
                <el-col :span="4">1</el-col>
                <el-col :span="4" style="border-right:1px solid rgb(242,242,242)"><el-link @click.native="sc">删除</el-link></el-col>
              </el-row>
               <el-row class="ts1">
                <el-col :span="4">广东省 </el-col>
                <el-col :span="4">1</el-col>
