<template>
  <div>
    <div class="nav_top">
      <p class="pj1">
        <span>
          <a style="margin-left: 9px;">新增服务</a>
        </span>
      </p>
    </div>
    <div class="box">
      <table class="bg" style="border-collapse:collapse;    margin-bottom: 30px;">
        <tr>
          ...
          <td class="secend">
           <div>自定义服务
            <el-link type="warning" style="    margin: -4px 0 0 8px;" @click.native="xgs">修改</el-link>
           </div>
          </td>
        </tr>
        <tr>
          ...
          <td class="secend">
           <div>上门家政<el-link type="warning" style="    margin: -4px 0 0 8px;" @click.native="xgs">修改</el-link></div>
          </td>
        </tr>
        <tr>
          <td style="background:rgb(250,250,250)" class="first">
  ...
  <el-form-item label="价格:">
   <el-input placeholder="请输入内容" style="width:200px;margin-left:10px" v-model="s.n1">
    <template slot="prepend">原价</template>
  </el-input>
  <el-input placeholder="请输入内容" style="width:200px;margin-left:10px" v-model="s.n2">
  ...
  <el-form-item label="库存: ">
    <el-input style="width:250px" maxlength=30 v-model="s.n3"></el-input>

  </el-form-item>
  <el-form-item label="最大购买量: ">
    <el-input style="width:250px" maxlength=30 v-model="s.n4"></el-input>

  </el-form-item>
   <el-form-item label="最小购买量: ">
    <el-input style="width:250px" maxlength=30 v-model="s.n5"></el-input>

  </el-form-item>
     <el-form-item label="虚拟购买量: ">
    <el-input style="width:250px" maxlength=30 v-model="s.n6"></el-input>
