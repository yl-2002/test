...
">
  ...
  <el-form-item label="最大购买量: ">
   ...
   <el-form-item label="最小购买量: ">
    ...
    <el-input style="width:250px" maxlength=30 ></el-input>
        ...
        <tr>
          <td style="background:rgb(250,250,250)" class="first">物流配置：</td>
          <td class="secend" style="padding-left:20px">
           <el-radio v-model="radios" label="1">物流配送</el-radio>
  <el-radio v-model="radios" label="2">无需配送</el-radio><br>
     运费模板：<el-select v-model="values" placeholder="请选择">
    <el-option
    @change="ff"
  ...
  <span style="margin-left:20px" v-show="mr"> 默认运费：1件内9元，每增加1件，加5元
发货地：广东-广州-天河区</span>
  <br>
           <el-checkbox v-model="checked">允许自提</el-checkbox>
           </td>
        </tr>
        <tr>
